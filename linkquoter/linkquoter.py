...
class LinkQuoter(Cog):
    ...
    async def migratefromlinkquoter(self, ctx: commands.Context) -> None:
        ...
        old_config: Config = Config.get_conf(
            "LinkQuoter", identifier=6234567898747434823, force_registration=True, cog_name="Seen"
        )
