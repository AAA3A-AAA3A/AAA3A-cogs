...
class SnipedMessage:
    def __init__(
        ...
        self.channel: discord.TextChannel | discord.VoiceChannel | discord.Thread | None = (
            message.channel
        )
        ...
        self.embeds: list[discord.Embed] = message.embeds.copy()
        self.attachments: list[discord.Attachment] = message.attachments.copy()
        self.stickers: list[discord.Sticker] = message.stickers.copy()

        self.mentions: list[discord.Member] = message.mentions.copy()
        self.role_mentions: list[discord.Role] = message.role_mentions.copy()
        self.member_mentions: list[discord.Member | discord.User] = [
            mention
    ...
    def to_embed(self, embed_color: discord.Color = discord.Color.green()) -> discord.Embed:
        ...
        if image is None and self.stickers:
...
class Snipe(DashboardIntegration, Cog):
    ...
    __authors__: list[str] = ["epic guy", "AAA3A"]

    def __init__(self, bot: Red) -> None:
        super().__init__(bot=bot)

        self.deleted_messages: dict[
